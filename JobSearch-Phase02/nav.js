document.addEventListener("DOMContentLoaded", function () {
  ...
  if (user && user.role === "admin") {
    list.appendChild(navItem("admin-dashboard.html", "📊 Dashboard"));
    list.appendChild(navItem("my-jobs.html", "💼 My Jobs"));
    list.appendChild(navItem("create-job.html", "➕ Add Job"));
    ...
    list.appendChild(navItem("home.html", "🏠 Home"));
    list.appendChild(navItem("jobs.html", "💼 Jobs"));
    list.appendChild(navItem("search.html", "🔍 Search"));
    list.appendChild(navItem("applied-jobs.html", "📋 My Applications"));
    list.appendChild(navItem("profile.html", "👤 Profile"));
